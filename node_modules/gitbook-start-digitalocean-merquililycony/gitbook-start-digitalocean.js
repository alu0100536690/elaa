...
function checkDirectorySync(directory) {
  try {
    ...
    //var usuario_docean = readlineSync.question('Introduzca el USUARIO de Digital Ocean: ');
    //var password_docean = readlineSync.question('Introduzca su contraseña de Digital Ocean: ');
    //var ruta_docean = readlineSync.question('Introduzca la ruta de despliegue en Digital Ocean: ');
    //var password_docean = readlineSync.question('Introduzca su contraseña de Digital Ocean: ');
...
var getPwd = function(repo_name){
  ...
  exec('git remote add origin git@github.com:'+usuario_tok+'/'+repo_name+'.git; git push -u origin master');
